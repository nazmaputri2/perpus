    ...
    <div class="relative p-4 w-full max-w-lg max-h-full">
        <div class="relative bg-white rounded-2xl shadow-2xl">
            ...
            <form action="{{ route('siswa.import') }}" method="POST" enctype="multipart/form-data" class="p-4 md:p-5">
                ...
                <div class="mb-6">
                    <label for="file_import" class="block mb-2 text-sm font-medium text-gray-900">Pilih File untuk
                        Diunggah</label>
                    ...
                    <p class="mt-1 text-xs text-gray-500" id="file_input_help">Hanya file .XLS atau .XLSX yang diterima.
                    </p>
                </div>

                <div class="flex items-center justify-end pt-4 border-t">
                    <button data-modal-hide="importDataModal" type="button"
