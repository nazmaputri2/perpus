        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="pt-2 pb-6 px-6 space-y-6">
                <form id="edit-form" method="POST" class="space-y-4">
                    ...
                    <div>
                        <label for="edit-keanggotaan"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kelas</label>
                        <select id="edit-keanggotaan" name="keanggotaan" required
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    ...
                    <div>
                        <label for="edit-nohp_anggota"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">No HP</label>
                        <input type="text" id="edit-nohp_anggota" name="nohp_anggota" required minlength="10"
