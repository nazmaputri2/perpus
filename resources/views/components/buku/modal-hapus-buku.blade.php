    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-xl shadow-lg dark:bg-gray-800">
            <div class="flex items-center justify-between p-4 border-b rounded-t dark:border-gray-600">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Konfirmasi Hapus Buku</h3>
                <button type="button" data-modal-hide="deleteConfirmationModal" type="button" 
            ...
            <div class="p-6 text-center">
                ...
                <form id="deleteBookForm" method="POST">
                    ...
                    <button data-modal-hide="deleteConfirmationModal" type="button"
