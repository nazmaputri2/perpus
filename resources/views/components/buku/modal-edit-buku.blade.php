    <div id="editbuku" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-lg max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Form Edit (unchanged) -->
                <form action="kelola/edit_buku.php" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="edit-judul_buku" name="judul_buku" required
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select id="edit-tahun_terbit" name="tahun_terbit" required
                                ...
                                <!-- Year options would be generated here -->
                            </select>
                        </div>
                        <div>
                            <label for="edit-stok"
