                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-gray-900">
                                            {{ \Carbon\Carbon::parse($data->tanggal_peminjaman)->translatedFormat('d F Y') }}
                                        </p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-gray-900">
                                            {{ \Carbon\Carbon::parse($data->tanggal_pengembalian)->translatedFormat('d F Y') }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col justify-between">
                                <div class="mb-4">
                                    ...
                                    @endphp
                                    <span
                                        class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium {{ $status['bg'] }} border">
                                ...
                                <div class="flex gap-3">
                                    @if ($data->status_peminjaman === 'Proses')
                                        <form action="{{ route('peminjaman.updateStatus', $data->id_peminjaman) }}"
                                            ...
                                            <button
                                                class="flex-1 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-xl font-medium">
                                    ...
                                    @elseif (in_array($data->status_peminjaman, ['Dipinjam', 'Terlambat']))
                                        <form action="{{ route('peminjaman.updateStatus', $data->id_peminjaman) }}"
                                            ...
                                            <button
                                                class="flex-1 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium">
                                        ...
                                        <form action="{{ route('peminjaman.updateStatus', $data->id_peminjaman) }}"
                                            ...
                                            <button
                                                class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-xl font-medium">
    ...
    <script>
        function toggleStatus(button) {
            ...
            statusBadge.className =
                'inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-green-100 text-green-800 border border-green-200';
            statusBadge.innerHTML = '<i class="fas fa-check-circle mr-2"></i>Selesai';
            // Update button
            button.innerHTML = '<i class="fas fa-undo mr-2"></i>Batalkan';
            button.className =
                'flex-1 px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-xl font-medium transition-colors shadow-md';
            // Update progress bar
