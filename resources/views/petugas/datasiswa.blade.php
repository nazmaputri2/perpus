            ...
            <table class="w-full text-sm text-left text-gray-800 border border-gray-300">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b hover:bg-gray-50">
                        <td class="px-4 py-3">{{ $student->nis_siswa }}</td>
                        <td class="px-4 py-3">{{ $student->nama_siswa }}</td>
                        <td class="px-4 py-3">{{ $student->kelamin_siswa }}</td>
                        <td class="px-4 py-3">{{ $student->kelas_siswa }}</td>
                        <td class="px-4 py-3">{{ $student->nohp_siswa }}</td>
                        <td class="px-4 py-3">
